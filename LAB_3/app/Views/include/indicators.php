	...
	<div id="myCarousel1" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
          ...
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="salates" role="button">Purchase &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="themes/assets/images/burger.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="purchase2" role="button">Purchase &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="themes/assets/images/drinks.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="drinks" role="button">Purchase &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
        ...
        <div class="col-lg-4">
          <img src="themes/assets/images/drinks.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="drins\ks" role="button">Purchase &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
         <img src="themes/assets/images/chicken.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="chicken" role="button">Purchase &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div id="myCarousel3" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
          ...
          <h4>Rice</h4>
          <p><a class="btn btn-default" href="rice" role="button">Purchase &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="themes/assets/images/drinks.png" alt="Generic placeholder image">
          <h4>Drink</h4>
