                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="tableData">Data Tables</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="signup">Sign up Page</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="fPass">Forgot Password</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <tr>
                                ...
                                <?php foreach ($tableData as $commerce): ?>
            <tr>
                <td><?= $commerce['ProductName']?></td>
                <td><?= $commerce['Description']?></td>
                <td><?= $commerce['Category']?></td>
                <td><?= $commerce['Quantity']?></td>
                <td><?= $commerce['Price']?></td>
                <td><?= $commerce['Image']?></td>
                <td>
                    <a href="/edit/ <?= $commerce['id']?>" class="btn btn-success btn-sm">edit</a>
                    <a href="/delete/<?= $commerce['id']?>" class="btn btn-danger btn-sm">delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
                    </table>                    
                    <a href="<?php echo base_url().'/insert'; ?>" type="submit" value="Add new product" class="btn btn-primary">Add new Product</a>

                    <!-- <a href="/edit/Product " class="btn btn-success btn-sm">edit</a>
                    <a href="/delete/tableData " class="btn btn-danger btn-sm">delete</a> -->
                </td>
                    </table>                    
                                </div>
                            </div>
